<template>
  <sl-dialog ref="uploadGoodsExecl" title="库存调整" :showFooter="false" :showClose="false" :closeOnClickModal="false" :closeOnPressEscape="false">
